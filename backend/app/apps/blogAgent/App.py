...
# ================================================================================
# FILE: apps/blogAgent/App.py — Blog Writing Agent (Streamlit UI)
# ================================================================================
# Why this file is used:
#   - This is the Streamlit UI file for the AI-powered Blog Writing Agent.
#   - It provides inputs for topics, tones, and options, rendering research paths.
# ================================================================================
...
def embed_images(md: str) -> str:
    """images/ paths ko base64 mein convert karo taaki Streamlit render kare"""
    def replace_img(match):
        alt = match.group(1)
        path = match.group(2)
        img_path = IMAGES_DIR / Path(path).name
        if img_path.exists():
...
with tab_preview:
    ...
    if not md:
        ...
        st.markdown(embed_images(md), unsafe_allow_html=True)
